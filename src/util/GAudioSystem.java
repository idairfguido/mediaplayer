...
import static util.comp.Constants.*;
...
public class GAudioSystem {
    ...
    /** COntrole selecionado para a porta selecionada (only for Source Ports) */
    private BooleanControl[] portSelect = new BooleanControl[2];
    private int[] portIndex = new int[2];

    /** Todos os  compound controls disponiveis pro sistema, uma lista */
    private List<String> portNames[] = new List[2]; // $$ generics

    /** Toas as portas disponiveis para o sistema (maybe the same ones) */
    ...
    /** MIxer selecionado. Se null, use default */
